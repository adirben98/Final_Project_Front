...
const HomePage: React.FC = () => {
  ...
  return (
    <div
      style={{ display: "flex", flexDirection: "column", paddingTop: "150px" }}
    >
      <video src={homePageVid} autoPlay loop muted style={videoStyle} />
      <div style={contentStyle}>
        <section style={openingPhraseStyle}>Your Story, Your Way</section>
        <section style={descriptionStyle}>
          At Bookify, we believe that every story deserves to be told—and no one
          can tell it like you can. We’re excited to welcome you into a world
          where your creativity takes center stage. Here, you’re not just
          creating a book; you’re crafting a one-of-a-kind adventure tailored to
          your imagination. Choose your hero, weave your tale, and watch as your
          personalized story unfolds. Share it with others, gather inspiration,
          and connect with a community of storytellers who value the uniqueness
          of your voice. With Bookify, your story isn’t just a book—it’s an
          experience, as original and special as you are.
        </section>
        ...
        <section
          style={{ marginBottom: "40px", width: "100%", marginTop: "40px" }}
        >
          ...
          <div style={{ width: "50%", padding: "50px", margin: "0 auto" }}>
            <Slider {...settings}>
              {heroes.map((hero, index) => (
                <div key={index}>
                  <Link to={`/search?q=${hero.name}&f=heroes`}>
                    <img
                      src={hero.image}
                      onClick={() => {
                        console.log("clicked");
